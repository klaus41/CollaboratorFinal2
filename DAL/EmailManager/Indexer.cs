...
namespace DAL.EmailManager
{
    public class Indexer
    {
        ...
        //private void Check(SearchCriteria searchCriteria, Email email)
        //{
        //    string c = searchCriteria.Criteria;
        //    if (email.BodyText != null && email.BodyText.IndexOf(c, StringComparison.OrdinalIgnoreCase) >= 0 ||
        //                                email.ReceivedDate != null && email.ReceivedDate.ToString().IndexOf(c, StringComparison.OrdinalIgnoreCase) >= 0 ||
        //                                email.Recipiant != null && email.Recipiant.IndexOf(c, StringComparison.OrdinalIgnoreCase) >= 0 ||
        //                                email.Sender != null && email.Sender.IndexOf(c, StringComparison.OrdinalIgnoreCase) >= 0 ||
        //                                email.Subject != null && email.Subject.IndexOf(c, StringComparison.OrdinalIgnoreCase) >= 0)
        //    {
        //        //email.SearchCriteria.Add(searchCriteria);
        //        if (!email.SearchCriteria.Contains(searchCriteria))
        //        {
